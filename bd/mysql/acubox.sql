...
INSERT INTO `sensor` (`idSensor`, `mac`, `nombre`, `ubicacion`, `x`, `y`, `idAula`) VALUES
(1, 'MAC1', 'sensor1', 'aula1', 1, 1, 1),
(2, 'MAC2', 'sensor2', 'aula1', 2, 2, 1),
(3, 'MAC3','sensor3', 'aula1', 3, 3, 1),
(4, 'MAC4','sensor4', 'aula1', 4, 4, 1),
(5, 'MAC5','sensor5', 'aula1', 5, 5, 1);

INSERT INTO `newsensor` (`idSensor`, `mac`, `ip_sensor`, `accepted`) VALUES
(1, 'MAC1', '192.168.1.1', 0),
(2, 'MAC2', '192.168.1.1', 0),
(3, 'MAC3', '192.168.1.1', 0),
(4, 'MAC4', '192.168.1.1', 0);
--
