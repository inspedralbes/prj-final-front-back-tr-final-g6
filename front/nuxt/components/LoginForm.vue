<template>
  <div
    class="w-full max-w-4xl bg-slate-800 rounded-xl shadow-2xl overflow-hidden border border-slate-700"
  >
    <!-- Hero Section with Gradient Background -->
    <div class="bg-gradient-to-r from-teal-800 to-blue-900 p-8 md:p-12 text-center">
      <div class="flex flex-col items-center mb-6">
        <div
          class="w-20 h-20 bg-white/10 rounded-full backdrop-blur-sm flex items-center justify-center mb-4 overflow-hidden"
        >
        ...
        <h1 class="text-4xl md:text-5xl font-bold text-white tracking-tight">ACOUBOX</h1>
    ...
    <div class="p-8 md:p-12">
      <div class="max-w-md mx-auto">
        <h1 class="text-3xl font-bold text-white text-center mb-8">Iniciar Sessió</h1>
...
const handleLogin = async () => {
  try {
    ...
    if (response && response.user) {
      ...
      errorMessage.value =
        "Credencials incorrectes. Si us plau, comprova el correu i la contrasenya.";
    }
  } catch (error) {
