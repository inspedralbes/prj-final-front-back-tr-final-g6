      ...
      >
        ...
        <form @submit.prevent="handleCreateAula" class="space-y-4">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label for="Curs" class="block text-sm font-medium text-slate-300 mb-2"
                >Curs:</label
              >
              <input
                v-model="newAula.Curs"
                type="text"
                placeholder="Curs"
            ...
            <div>
              <label for="Classe" class="block text-sm font-medium text-slate-300 mb-2"
                >Classe:</label
              >
              <input
                v-model="newAula.Classe"
                type="text"
                placeholder="Classe"
                class="w-full p-3 rounded-lg bg-slate-700 border border-slate-600 text-white focus:ring-2 focus:ring-teal-500 focus:outline-none transition-all"
              />
            ...
            <div>
              <label for="Etapa" class="block text-sm font-medium text-slate-300 mb-2"
                >Etapa:</label
              >
              <select
                v-model="newAula.Etapa"
                class="w-full p-3 rounded-lg bg-slate-700 border border-slate-600 text-white focus:ring-2 focus:ring-teal-500 focus:outline-none transition-all"
              >
            ...
            <div>
              <label for="Planta" class="block text-sm font-medium text-slate-300 mb-2"
                >Planta:</label
              >
              <input
                v-model="newAula.Planta"
                type="number"
                placeholder="Planta"
                class="w-full p-3 rounded-lg bg-slate-700 border border-slate-600 text-white focus:ring-2 focus:ring-teal-500 focus:outline-none transition-all"
              />
            ...
            <div>
              <label for="Aula" class="block text-sm font-medium text-slate-300 mb-2"
                >Aula:</label
              >
              <input
                v-model="newAula.Aula"
                type="number"
                placeholder="Aula"
                class="w-full p-3 rounded-lg bg-slate-700 border border-slate-600 text-white focus:ring-2 focus:ring-teal-500 focus:outline-none transition-all"
              />
            ...
            <div>
              <label for="turn" class="block text-sm font-medium text-slate-300 mb-2"
                >Torn:</label
              >
              <select
                v-model="newAula.turn"
                class="w-full p-3 rounded-lg bg-slate-700 border border-slate-600 text-white focus:ring-2 focus:ring-teal-500 focus:outline-none transition-all"
              >
            ...
            <div v-if="aula.showDetails" class="mt-6 space-y-4" @click.stop>
              <template v-if="!aula.editing">
                ...
                <div class="flex flex-wrap gap-3 pt-4">
                  ...
                  <button
                    @click.stop="handleDeleteAula(aula.id)"
              ...
              <form v-else @submit.prevent="saveEdit(aula)" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      v-if="editData.Classe === '_new'"
                      v-model="editData.newClasse"
                      type="text"
