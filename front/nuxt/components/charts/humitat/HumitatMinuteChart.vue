...
.hum-low {
    color: #FF6384; /* Red for very low humidity */
}

.hum-medium {
    color: #FFCE56; /* Yellow for medium-low humidity */
}

.hum-high {
    color: #36A2EB; /* Blue for ideal humidity */
}

.hum-very-high {
    color: #4BC0C0; /* Teal for high humidity */
}
