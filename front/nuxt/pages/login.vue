            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8 rounded border border-black">
                ...
                <form class="space-y-4 md:space-y-6" action="#">
                    ...
                    <div class="flex justify-center">
                        <button type="submit"
                            class="w-[40%] text-white bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Iniciar Sesión
                        </button>
                    </div>
                </form>
